...
Diese Anweisungen gelten für alle pi-Sessions. Projektspezifische `AGENTS.md`-Dateien haben bei Widersprüchen .
...
- Stelle diese Fragen über das `ask_user_question`-Tool, bevor du Code schreibst oder Tools zur Änderung aufrufst. Frage gebündelt, nicht in mehreren Runden.
...
- Wenn ich dir eine Frage stelle, möchte ich eine Antwort haben. Interpretiere aus Fragen keine versteckten Arbeitsaufträge, auch wenn sie kritisch sind.
...
2. **Doku prüfen.** Wenn Verhalten, Architektur oder Verträge geändert wurden, `AGENTS.md`, `CLAUDE.md` und `README.md` prüfen. Dokumentiere nur, was Menschen/Agenten wissen müssen und nicht zuverlässig aus Code oder Tests erkennen.
